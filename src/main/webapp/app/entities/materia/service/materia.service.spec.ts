...
describe('Materia Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      idMateriaDenominacion: 0,
      marcaModulo: 'AAAAAAA',
      cargaHoraria: 0,
      idOfertaEducativa: 0,
      idSeccion: 0,
      idTipoMateriaOpcional: 0,
      orden: 0,
      idArea: 0,
      idAsignatira: 0,
      codigosChequeados: 0,
      obligatoriedad: 0,
      unidadCargaPedagogica: 0,
    };
  });
  ...
  describe('Service methods', () => {
    ...
    it('should update a Materia', () => {
      const returnedFromService = Object.assign(
        {
          id: 1,
          idMateriaDenominacion: 1,
          marcaModulo: 'BBBBBB',
          cargaHoraria: 1,
          idOfertaEducativa: 1,
          idSeccion: 1,
          idTipoMateriaOpcional: 1,
          orden: 1,
          idArea: 1,
          idAsignatira: 1,
          codigosChequeados: 1,
          obligatoriedad: 1,
          unidadCargaPedagogica: 1,
        },
        elemDefault
      );
    ...
    describe('addMateriaToCollectionIfMissing', () => {
      ...
      it('should add only unique Materia to an array', () => {
        const materiaArray: IMateria[] = [{ id: 123 }, { id: 456 }, { id: 96500 }];
