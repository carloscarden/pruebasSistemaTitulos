...
describe('Rendicion Management Component', () => {
  let comp: RendicionComponent;
  let fixture: ComponentFixture<RendicionComponent>;
  let service: RendicionService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'rendicion', component: RendicionComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(RendicionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.rendicions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
