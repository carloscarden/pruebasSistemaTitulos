...
/**
 * REST controller for managing {@link com.dgcye.domain.Materia}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class MateriaResource {
    ...
    public ResponseEntity<Materia> partialUpdateMateria(
        ...
        Optional<Materia> result = materiaRepository
            ...
            .map(existingMateria -> {
                if (materia.getIdMateriaDenominacion() != null) {
                    existingMateria.setIdMateriaDenominacion(materia.getIdMateriaDenominacion());
                }
                if (materia.getMarcaModulo() != null) {
                    existingMateria.setMarcaModulo(materia.getMarcaModulo());
                }
                if (materia.getCargaHoraria() != null) {
                    existingMateria.setCargaHoraria(materia.getCargaHoraria());
                }
                if (materia.getIdOfertaEducativa() != null) {
                    existingMateria.setIdOfertaEducativa(materia.getIdOfertaEducativa());
                }
                if (materia.getIdSeccion() != null) {
                    existingMateria.setIdSeccion(materia.getIdSeccion());
                }
                if (materia.getIdTipoMateriaOpcional() != null) {
                    existingMateria.setIdTipoMateriaOpcional(materia.getIdTipoMateriaOpcional());
                }
                if (materia.getOrden() != null) {
                    existingMateria.setOrden(materia.getOrden());
                }
                if (materia.getIdArea() != null) {
                    existingMateria.setIdArea(materia.getIdArea());
                }
                if (materia.getIdAsignatira() != null) {
                    existingMateria.setIdAsignatira(materia.getIdAsignatira());
                }
                if (materia.getCodigosChequeados() != null) {
                    existingMateria.setCodigosChequeados(materia.getCodigosChequeados());
                }
                if (materia.getObligatoriedad() != null) {
                    existingMateria.setObligatoriedad(materia.getObligatoriedad());
                }
                if (materia.getUnidadCargaPedagogica() != null) {
                    existingMateria.setUnidadCargaPedagogica(materia.getUnidadCargaPedagogica());
                }
